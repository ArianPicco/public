...
document.addEventListener('DOMContentLoaded', (event) => {
  ...
  function playCeroFront() {
    const audio0223 = document.querySelector('#audio0223');
    const play0223f = document.querySelector('#playMobile0223');
    play0223f.addEventListener('click', function () {
      if (audio0223.paused) {
        audio0223.play();
      } else {
        audio0223.pause();
  ...
  function playLangFront() {
    const audioLang = document.querySelector('#audioLang');
    const playLangF = document.querySelector('#playMobileLAN');
    playLangF.addEventListener('click', function () {
      if (audioLang.paused) {
        audioLang.play();
      } else {
        audioLang.pause();
  ...
  function playParrillaFront() {
    const audioParrilla = document.querySelector('#audioParrilla')
    const playParrillaF = document.querySelector('#playParrillaFront')
    playParrillaF.addEventListener('click', function () {
      if (audioLang.paused) {
        audioParrilla.play();
      } else {
        audioParrilla.pause();
  ...
  function playRDSfront() {
    const audioRDS = document.querySelector('#audioRDS')
    const playRDSfront = document.querySelector('#playRDSfront')
    playRDSfront.addEventListener('click', function () {
      if (audioRDS.paused) {
        audioRDS.play();
      } else {
        audioRDS.pause();
  ...
  function playSTRFront() {
    const audioSTR = document.querySelector('#audioSTR')
    const playSTRFront1 = document.querySelector('#playSTRFront')
    playSTRFront1.addEventListener('click', function () {
      if (audioSTR.paused) {
        audioSTR.play();
      } else {
        audioSTR.pause();
  ...
  function playATfront() {
    const audioAT = document.querySelector('#audioAT')
    const playATfront = document.querySelector('#playATfront')
    playATfront.addEventListener('click', function () {
      if (audioAT.paused) {
        audioAT.play();
      } else {
        audioAT.pause();
